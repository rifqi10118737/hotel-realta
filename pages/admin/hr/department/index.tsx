...
import { Col, Row, Space, Table, Input, Button, Dropdown, Menu, Popconfirm, message, MenuProps } from "antd";
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        const items: MenuProps['items'] = [
          {
            label: <a href="#" onClick={() => showModal("Edit", record.deptId)}>Edit</a>,
            key: "Edit" + record.deptId,
          },
          {
            label: <Popconfirm
              key={`DeleteConfirm${record.deptId}`}
              title="Delete the task"
              description="Are you sure to delete department?"
              onConfirm={() => {
                if ({ confirm }) {
